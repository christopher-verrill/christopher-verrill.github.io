...
//   EDIT THINGS HERE
  ...
  const HEARDLE_GLITCH_NAME = "tommyshriggly-heardle";
  
  const HEARDLE_URL = "https://"+HEARDLE_GLITCH_NAME+".glitch.me/";
  
  const HEARDLE_ARTIST = "Tommy Shriggly";
  
  const HEARDLE_NAME = HEARDLE_ARTIST + " Heardle";
  
  const HEARDLE_START_DATE = "2024-11-14";
  
  // make sure you have 7 comments here
  const HEARDLE_GAME_COMMENTS = [
      "Tommy Shriggly is going to hunt you down in the dead of the night.", // FAILED
      "You just found $100,000.", // First try
      "Can I get a little clap?",
      "You've earned some protein powder.",
      "You got your head out of your ass.",
      "I bet you're feeling good, like you could run two miles in 35 minutes right now.",
      "You found $100,000, invested it, and turned it into $16,000." // Sixth try
    ]; 
